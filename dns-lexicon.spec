...
Source0  : https://files.pythonhosted.org/packages/f8/e3/0196809d4f6b288515806ce93876e2ea96f59a8f649d8778a71daa4e4fe2/dns-lexicon-3.3.16.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.3.16
cd %{_builddir}/dns-lexicon-3.3.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578929113
...
cp %{_builddir}/dns-lexicon-3.3.16/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
