...
Version  : 3.4.5
Release  : 37
URL      : https://files.pythonhosted.org/packages/9a/3f/d2a104dd1ec0f43c6f027006ecea0ea0f6dcac014a6756cc4fa28472a635/dns-lexicon-3.4.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/9a/3f/d2a104dd1ec0f43c6f027006ecea0ea0f6dcac014a6756cc4fa28472a635/dns-lexicon-3.4.5.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.4.5
cd %{_builddir}/dns-lexicon-3.4.5
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604508592
...
cp %{_builddir}/dns-lexicon-3.4.5/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
