...
Version  : 3.4.4
Release  : 36
URL      : https://files.pythonhosted.org/packages/86/07/09cd8ceb0cf7e5e1815f2ec4fef950ca78dbe95da42794b97a160420396c/dns-lexicon-3.4.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/86/07/09cd8ceb0cf7e5e1815f2ec4fef950ca78dbe95da42794b97a160420396c/dns-lexicon-3.4.4.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.4.4
cd %{_builddir}/dns-lexicon-3.4.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603723599
...
cp %{_builddir}/dns-lexicon-3.4.4/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
