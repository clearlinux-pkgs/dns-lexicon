...
%prep
%setup -q -n dns-lexicon-3.6.1
cd %{_builddir}/dns-lexicon-3.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624891594
...
cp %{_builddir}/dns-lexicon-3.6.1/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
