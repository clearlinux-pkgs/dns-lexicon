...
Source0  : https://files.pythonhosted.org/packages/f6/ce/8d28fe1403559eefee489e0843fef68ca38da40ee1325c860281058ecb15/dns-lexicon-3.3.28.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.3.28
cd %{_builddir}/dns-lexicon-3.3.28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595863971
...
cp %{_builddir}/dns-lexicon-3.3.28/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
