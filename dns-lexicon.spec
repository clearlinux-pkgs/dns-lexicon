...
Version  : 3.8.2
Release  : 57
URL      : https://files.pythonhosted.org/packages/95/7d/4957f450918108845077640784db81bc0285dca624b7db7fe6ebdfdc194d/dns-lexicon-3.8.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/95/7d/4957f450918108845077640784db81bc0285dca624b7db7fe6ebdfdc194d/dns-lexicon-3.8.2.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.8.2
cd %{_builddir}/dns-lexicon-3.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636038702
...
cp %{_builddir}/dns-lexicon-3.8.2/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
