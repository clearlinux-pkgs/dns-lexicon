...
Source0  : https://files.pythonhosted.org/packages/bf/fa/ce3f0ec260e925e960e1abb4232791517b3c1d710b7c08af3d8d4660cb96/dns-lexicon-3.3.17.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.3.17
cd %{_builddir}/dns-lexicon-3.3.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582919368
...
cp %{_builddir}/dns-lexicon-3.3.17/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
