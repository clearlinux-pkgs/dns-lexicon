...
Source0  : https://files.pythonhosted.org/packages/a5/25/882e4d6ee25fef010a79e2996b3ebd9f01de93eae98413988a57f79a132a/dns-lexicon-3.3.9.tar.gz
...
%prep
%setup -q -n dns-lexicon-3.3.9
cd %{_builddir}/dns-lexicon-3.3.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573790679
...
cp %{_builddir}/dns-lexicon-3.3.9/LICENSE %{buildroot}/usr/share/package-licenses/dns-lexicon/d7389b6482179505c25d9b209b006826fcb6b85c
